...
tematica <-function(listaDocumentos){
  ...
  for (i in 1:length(listaDocumentos)){
    if(listaDocumentos[[i]][1]=="of"){if(listaDocumentos[[i]][2]=="av01"){
        codigo_av01<-c(codigo_av01,listaDocumentos[[i]][3])
      }else if(listaDocumentos[[i]][2]=="av02"){
        codigo_av02<-c(codigo_av02,listaDocumentos[[i]][3])
      }else if(listaDocumentos[[i]][2]=="av03"){
        codigo_av03<-c(codigo_av03,listaDocumentos[[i]][3])
      }else if(listaDocumentos[[i]][2]=="av04"){
        codigo_av04<-c(codigo_av04,listaDocumentos[[i]][3])
      }else if(listaDocumentos[[i]][2]=="av05"){
        codigo_av05<-c(codigo_av05,listaDocumentos[[i]][3])
      }else if(listaDocumentos[[i]][2]=="av07"){
        codigo_av07<-c(codigo_av07,listaDocumentos[[i]][3])
      }else  if(listaDocumentos[[i]][2]=="av08"){
        codigo_av08<-c(codigo_av08,listaDocumentos[[i]][3])
      }}else{"no existe"}}
